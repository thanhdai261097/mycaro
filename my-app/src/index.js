    ...
    return (
      <div class="content">
        <div className="game-config">
          <span className="fixed-size">Width:</span><input type="number" placeholder="Chiều rộng" value={this.state.inputWidth} onChange={this.handleChangeWidth} />
          <br />
          <span className="fixed-size">Height:</span><input type="number" placeholder="Chiều cao" value={this.state.inputHeight} onChange={this.handleChangeHeight} />
        </div>
        <div className="game">
          ...
          <div className="game-info">
            <div>
              <button onClick={this.sort}>Sort move</button>
            </div>
            <div>{status}</div>
            <ol>{moves}</ol>
          </div>
